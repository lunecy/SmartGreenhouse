<?php include('soilserver.php'); ?>
<!DOCTYPE html>
<html>
<head> 
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width">
	<title>Concordia Greenhouse | Soil Moisture</title> 
	...
	<ul> 
		...
		<li class="current"><a href="#">Graphs</a> 
			<ul> 
				...
				<li><a href="soil.php">Soil Moisture</a></li> 
...
<?php include('soillastinserted.php'); ?>
...
svg.selectAll(".dot")
    ...
    .enter().append("circle")
      ...
      .attr("cy", function(d) { return y(d.moisture); })
      .style("fill", "#276d29")
